    ...
    return (
        <div className={`relative w-full ${className}`}>
            <input
                ...
                className="w-full pr-10 py-3 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 focus:ring-cyan-500 focus:border-transparent focus:ring-2 transition-all duration-200 outline-none text-gray-800 dark:text-white"
            />
