        ...
        >
          ...
          >
            ...
            <p className="text-sm text-center text-gray-500 dark:text-gray-400 mt-4">
              By creating an account, you agree to our <a href="#" className="text-cyan-500 hover:underline">Terms</a> and <a href="#" className="text-cyan-500 hover:underline">Privacy Policy</a>
            </p>
          </motion.form>
        </motion.div>
      </div>
