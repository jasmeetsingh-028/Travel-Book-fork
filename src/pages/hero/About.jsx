...
const About = () => {        
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">About Travel-Book</h2>
            <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">The web application lets you document and relive your memories effortlessly.</p>
        </div>
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Future</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">The platform will evolve with added features such as user reviews, personalized recommendations, and integration with popular travel APIs for better service.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Technology</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Built with React, Node.js, and MongoDB, the platform ensures a fast and reliable experience for users to browse and book trips effortlessly.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Security</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">User data is securely handled with encryption protocols, ensuring personal information and payment details are kept private and safe from unauthorized access.
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Design</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">The website uses modern, responsive design principles to ensure a seamless experience on desktops, tablets, and smartphones, with easy navigation.</p>
            </div>
        </div>
    </div>
</section>
